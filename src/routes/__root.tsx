...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SETL — Event settlement" },
      { name: "description", content: "Event-settlement app for promoters: budget, manage and reconcile events on one Performance sheet." },
      { name: "author", content: "SETL" },
      { property: "og:title", content: "SETL — Event settlement" },
